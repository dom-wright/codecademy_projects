const context = {
    ...
    instruments: [
        {
            image: 'public/images/electronic-keyboard.jpg',
        ...
        {
            image: 'public/images/electric-guitar.jpg',
        ...
        {
            image: 'public/images/bass-guitar.jpeg',
            name: 'Bass Guitar',
        ...
        {
            image: 'public/images/drum-kit.jpeg',
            name: 'Drum Kit',
...
const source2 = document.getElementById('templateHB').innerHTML
const template2 = Handlebars.compile(source2)
const compiledHtml2 = template(context);

document.getElementById('information').innerHTML = compiledHtml2